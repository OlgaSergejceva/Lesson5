/** Home Work:
 Write an application that prompts a student to input a day of the week, 
 and then it will display whether there are classes scheduled for that day.
 Day        Message
...
public class SwitchDays {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please enter a day of the week (from 1 to 7) to see whether there are any classes scheduled for that day:");
...
//            break;
//        case "saturday":
//        	System.out.println("Whole day classes");
//            break;
//        case "sunday":
