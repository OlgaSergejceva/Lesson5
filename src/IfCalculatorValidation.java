...
public class IfCalculatorValidation {
	...
	//input
		...
		if (operation != 1 && operation != 2 && operation !=3 && operation !=4) {
			System.out.println("Check your opertions number .");
			...
			if(operation == 1) {
				...
				//call multiply() method on the object to perform the subtract
				myCalc.multiply();
			}else if(operation == 4) {
				//call devide() method on the object to perform the subtract
				myCalc.devide();
			}
